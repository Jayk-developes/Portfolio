...
onMounted(() => {
  const CVLoaded = () => {
    ...
    let cert_button = document.getElementById(
      "certificate_button"
    ) as HTMLElement;
  ...
  if (useRoute().path == "/") {
    ...
    window.addEventListener("resize", () => {
      if (
        (window.innerWidth <= 600 && window.innerWidth != CurrentWindowWidth) ||
...
<template>
  ...
  <div v-if="certActive" class="show_cert">
    ...
    <div class="cert_container">
      ...
      <img
        src="../../media/certificates/Fachabi_Bescheinigung.png"
        alt="Fachabi2"
      />
