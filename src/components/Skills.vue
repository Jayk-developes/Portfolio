...
const skills = [
  ...
  {header: "Software", content: "- <strong>PyCharm Professional</strong><br>- <strong>Intellij Ultimate</strong><br>- <strong>Microsoft / Libre Office</strong><br>- <strong>Windows</strong><br>- <strong>Linux (Ubuntu, Debian)</strong><br>- <strong>Jetbrains</strong><br>- <strong>HeidiSQL</strong>"},
