  ...
  <div style="margin-top: 3rem;" class="flex_container">
    <div class="content">
      <div class="content_polaroid" v-for="skill in skills">
        ...
        <div class="content_polaroid_inside ">
          <p>{{skill.header}}</p>
